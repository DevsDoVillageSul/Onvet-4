                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name" placeholder="Digite o Nome" required value="{{ $user->name ?? '' }}" />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-label" for="nome">Função</label>
                                <input type="text" name="jobtitle" class="form-control" id="jobtitle" placeholder="Digite a Função" value="{{ $user->jobtitle ?? '' }}" />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="home_id" id="home_id" class="form-control" required>
                                    ...
                                    <option value="{{ $permission->id }}" {{ $permission->url == "" ? 'disabled="disabled"' : '' }}>
                                        {{ __('locale.'.$permission->name) }}
                                    </option>
                                    @foreach($permission->permissions as $filho)
                                    <option value="{{ $filho->id }}" {{ $filho->url == "" ? 'disabled="disabled"' : '' }} {{$filho->id == $user->home_id ?'selected="selected"' : '' }}>
                                        &nbsp;&nbsp; ->
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" id="email" placeholder="Digite o E-mail" required value="{{ $user->email ?? '' }}" />
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" id="phone" placeholder="Digite o Telefone" value="{{ $user->phone ?? '' }}" />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-label" for="nome">Celular</label>
                                <input type="text" name="cellphone" class="form-control" id="cellphone" placeholder="Digite o Celular" value="{{ $user->cellphone ?? '' }}" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="custom-control-primary custom-switch">
                                    <input type="checkbox" name="ativo" class="custom-control-input" id="ativo" value="1" {{ !isset($user->active) || ( isset($user->active) && $user->active == 1 ) ? 'checked="checked"' : '' }}>
